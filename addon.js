...
/* Интерфейс */
		...
		Lampa.SettingsApi.addParam({
					...
					field: {
						name: 'Отключить трейлеры',
						description: 'Плагин удаляет пункт "трейлеры" из кнопки онлайн просмотра'
					},
					onChange: function(value) {
						if (value == '1') {
							itemON('https://me-deadlock.github.io/lamp/notrailers.js', 'Отключение трейлеров', 'DeadLock', 'Notrailers');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://me-deadlock.github.io/lamp/notrailers.js";
							deletePlugin(pluginToRemoveUrl);
						}	
					},
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900');  hideInstall()
						var myResult = checkPlugin('https://me-deadlock.github.io/lamp/notrailers.js')
						setTimeout(function() {	
							$('div[data-name="Notrailers"]').append('<div class="settings-param__status one"></div>')
							if (myResult) {
								$('div[data-name="Notrailers"]').find('.settings-param__status').removeClass('active error wait').addClass('active')
							} else {
								$('div[data-name="Notrailers"]').find('.settings-param__status').removeClass('active error wait').addClass('error')
							}
						}, 100);			  
					}
		});
		...
		Lampa.SettingsApi.addParam({
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://me-deadlock.github.io/lamp/weather.js', 'Погода', '@scabrum', 'Weather');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://me-deadlock.github.io/lamp/weather.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						var myResult = checkPlugin('https://me-deadlock.github.io/lamp/weather.js')
						setTimeout(function() {	
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://me-deadlock.github.io/lamp/cub_off.js', 'Cub Off', '@scabrum', 'Cub_off');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://me-deadlock.github.io/lamp/cub_off.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						var myResult = checkPlugin('https://me-deadlock.github.io/lamp/cub_off.js')
						setTimeout(function() {	
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://me-deadlock.github.io/lamp/interface.js', 'Стильный Интерфейс', '@lampa', 'Style_interface_fix');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://me-deadlock.github.io/lamp/interface.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						var myResult = checkPlugin('https://me-deadlock.github.io/lamp/interface.js')
						setTimeout(function() {	
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://me-deadlock.github.io/lamp/source.js', 'Дополнительные Источники', '@scabrum', 'New_source');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://me-deadlock.github.io/lamp/source.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						var myResult = checkPlugin('https://me-deadlock.github.io/lamp/source.js')
						setTimeout(function() {	
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://me-deadlock.github.io/lamp/start.js', 'Start', '@scabrum', 'Start');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://me-deadlock.github.io/lamp/start.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
			                onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall()
						var myResult = checkPlugin('https://me-deadlock.github.io/lamp/start.js')
						setTimeout(function() {	
...
/* Управление */
		...
		Lampa.SettingsApi.addParam({
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://me-deadlock.github.io/lamp/redirect.js', 'Смена Сервера', '@scabrum', 'Redirect');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://me-deadlock.github.io/lamp/redirect.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						var myResult = checkPlugin('https://me-deadlock.github.io/lamp/redirect.js')
						setTimeout(function() {	
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://me-deadlock.github.io/lamp/timecode.js', 'Синхронизация Таймкодов', '@scabrum', 'Timecode');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://me-deadlock.github.io/lamp/timecode.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						var myResult = checkPlugin('https://me-deadlock.github.io/lamp/timecode.js')
						setTimeout(function() {	
...
/* Торрент */
		...
		Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://me-deadlock.github.io/lamp/jackett.js', 'Переключение Парсеров', '@AndreyURL54', 'Switch_Parser');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://me-deadlock.github.io/lamp/jackett.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						var myResult = checkPlugin('https://me-deadlock.github.io/lamp/jackett.js')
						setTimeout(function() {	
		...
		Lampa.SettingsApi.addParam({
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://me-deadlock.github.io/lamp/freetorr.js', 'Free Torrserver', '@scabrum', 'free_torr');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://me-deadlock.github.io/lamp/freetorr.js";
							deletePlugin(pluginToRemoveUrl);
                                                }
					},
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						var myResult = checkPlugin('https://me-deadlock.github.io/lamp/freetorr.js')
						setTimeout(function() {	
...
/* Телеканалы */
		...
		Lampa.SettingsApi.addParam({
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('https://me-deadlock.github.io/lamp/tv.js', 'Hack TV', '@scabrum', 'Hack_TV');
						}
						if (value == '2') {
							var pluginToRemoveUrl = "https://me-deadlock.github.io/lamp/tv.js";
							deletePlugin(pluginToRemoveUrl);
						}
					},
					onRender: function (item) {$('.settings-param__name', item).css('color','f3d900'); hideInstall();
						var myResult = checkPlugin('https://me-deadlock.github.io/lamp/tv.js')
						setTimeout(function() {	
